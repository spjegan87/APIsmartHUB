...
export function Sidebar({ isMobileOpen = false, onMobileClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      >
        {/* Logo Section */}
        <div className="flex items-center px-6 py-6 border-b border-[#3A4A99] relative">
            ...
            {navigation.map((item) => {
              ...
              return (
                <Link key={item.name} href={item.href}>
                  <div
                    className={cn(
                      "flex items-center px-4 py-3 text-base font-medium rounded-lg transition-all duration-200 cursor-pointer",
                      isActive
